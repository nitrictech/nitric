...
type QueueEnqueueRequestBatch struct {
	...
	Requests []*QueueEnqueueRequest `protobuf:"bytes,2,rep,name=requests,proto3" json:"requests,omitempty"`
}

func (x *QueueEnqueueRequestBatch) Reset() {
	*x = QueueEnqueueRequestBatch{}
...
func (x *QueueEnqueueRequestBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueueEnqueueRequestBatch) ProtoMessage() {}

func (x *QueueEnqueueRequestBatch) ProtoReflect() protoreflect.Message {
	mi := &file_nitric_proto_queues_v1_queues_proto_msgTypes[0]
...
// Deprecated: Use QueueEnqueueRequestBatch.ProtoReflect.Descriptor instead.
func (*QueueEnqueueRequestBatch) Descriptor() ([]byte, []int) {
	return file_nitric_proto_queues_v1_queues_proto_rawDescGZIP(), []int{0}
}

func (x *QueueEnqueueRequestBatch) GetQueueName() string {
	if x != nil {
		return x.QueueName
	}
	return ""
...
func (x *QueueEnqueueRequestBatch) GetRequests() []*QueueEnqueueRequest {
	if x != nil {
		return x.Requests
	}
	return nil
...
type QueueEnqueueResponse struct {
	...
	FailedRequests []*FailedEnqueueRequest `protobuf:"bytes,1,rep,name=failed_requests,json=failedRequests,proto3" json:"failed_requests,omitempty"`
}
...
func (x *QueueEnqueueResponse) GetFailedRequests() []*FailedEnqueueRequest {
	if x != nil {
...
func (x *QueueDequeueResponse) GetTasks() []*ReceivedTask {
	if x != nil {
		return x.Tasks
	}
	return nil
...
func (x *QueueEnqueueRequest) GetPayload() *structpb.Struct {
	if x != nil {
		return x.Payload
	}
	return nil
...
type FailedEnqueueRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The task that failed to be pushed
	Request *QueueEnqueueRequest `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
	// A message describing the failure
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
}

func (x *FailedEnqueueRequest) Reset() {
	*x = FailedEnqueueRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *FailedEnqueueRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailedEnqueueRequest) ProtoMessage() {}

func (x *FailedEnqueueRequest) ProtoReflect() protoreflect.Message {
	mi := &file_nitric_proto_queues_v1_queues_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailedEnqueueRequest.ProtoReflect.Descriptor instead.
func (*FailedEnqueueRequest) Descriptor() ([]byte, []int) {
	return file_nitric_proto_queues_v1_queues_proto_rawDescGZIP(), []int{8}
}

func (x *FailedEnqueueRequest) GetRequest() *QueueEnqueueRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *FailedEnqueueRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_nitric_proto_queues_v1_queues_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x75, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x82, 0x01, 0x0a, 0x18,
	0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x1d, 0x0a, 0x0a, 0x71, 0x75, 0x65, 0x75,
	0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x71, 0x75,
	0x65, 0x75, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x47, 0x0a, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6e, 0x69, 0x74, 0x72,
	...
	,
	...
	,
	...
	0x75, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x49,
	0x64, 0x22, 0x17, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x75, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65,
	0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x48, 0x0a, 0x13, 0x51, 0x75,
	...
	0x61, 0x64, 0x22, 0x77, 0x0a, 0x14, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x45, 0x6e, 0x71, 0x75,
	0x65, 0x75, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x45, 0x0a, 0x07, 0x72, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6e, 0x69,
	0x74, 0x72, 0x69, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65,
	0x73, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x75, 0x65, 0x45, 0x6e, 0x71, 0x75, 0x65, 0x75,
	...
	,
	...
	0x75, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x6e, 0x69, 0x74, 0x72,
	0x69, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x73, 0x2e,
	0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x75, 0x65, 0x44, 0x65, 0x71, 0x75, 0x65, 0x75, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x67, 0x0a, 0x08, 0x43, 0x6f, 0x6d, 0x70, 0x6c,
	0x65, 0x74, 0x65, 0x12, 0x2c, 0x2e, 0x6e, 0x69, 0x74, 0x72, 0x69, 0x63, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x71, 0x75, 0x65, 0x75, 0x65, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65,
	...
	,
...
var file_nitric_proto_queues_v1_queues_proto_goTypes = []interface{}{
	(*QueueEnqueueRequestBatch)(nil), // 0: nitric.proto.queues.v1.QueueEnqueueRequestBatch
	...
	(*QueueEnqueueRequest)(nil),      // 6: nitric.proto.queues.v1.QueueEnqueueRequest
	(*ReceivedTask)(nil),             // 7: nitric.proto.queues.v1.ReceivedTask
	(*FailedEnqueueRequest)(nil),     // 8: nitric.proto.queues.v1.FailedEnqueueRequest
	(*structpb.Struct)(nil),          // 9: google.protobuf.Struct
}
var file_nitric_proto_queues_v1_queues_proto_depIdxs = []int32{
	6, // 0: nitric.proto.queues.v1.QueueEnqueueRequestBatch.requests:type_name -> nitric.proto.queues.v1.QueueEnqueueRequest
	8, // 1: nitric.proto.queues.v1.QueueEnqueueResponse.failed_requests:type_name -> nitric.proto.queues.v1.FailedEnqueueRequest
	7, // 2: nitric.proto.queues.v1.QueueDequeueResponse.tasks:type_name -> nitric.proto.queues.v1.ReceivedTask
	9, // 3: nitric.proto.queues.v1.QueueEnqueueRequest.payload:type_name -> google.protobuf.Struct
	9, // 4: nitric.proto.queues.v1.ReceivedTask.payload:type_name -> google.protobuf.Struct
	6, // 5: nitric.proto.queues.v1.FailedEnqueueRequest.request:type_name -> nitric.proto.queues.v1.QueueEnqueueRequest
	0, // 6: nitric.proto.queues.v1.Queues.Enqueue:input_type -> nitric.proto.queues.v1.QueueEnqueueRequestBatch
...
func file_nitric_proto_queues_v1_queues_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nitric_proto_queues_v1_queues_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueueEnqueueRequestBatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_nitric_proto_queues_v1_queues_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FailedEnqueueRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
