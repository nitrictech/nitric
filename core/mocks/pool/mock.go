...
func (m *MockWorkerPool) GetMaxWorkers() int {
	m.ctrl.T.Helper()
...
func (mr *MockWorkerPoolMockRecorder) GetMaxWorkers() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMaxWorkers", reflect.TypeOf((*MockWorkerPool)(nil).GetMaxWorkers))
}

// GetMinWorkers mocks base method.
func (m *MockWorkerPool) GetMinWorkers() int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMinWorkers")
	ret0, _ := ret[0].(int)
	return ret0
}

// GetMinWorkers indicates an expected call of GetMinWorkers.
func (mr *MockWorkerPoolMockRecorder) GetMinWorkers() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMinWorkers", reflect.TypeOf((*MockWorkerPool)(nil).GetMinWorkers))
}
