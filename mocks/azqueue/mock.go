...
// Source: github.com/nitrictech/nitric/pkg/plugins/queue/azqueue/iface (interfaces: AzqueueServiceUrlIface,AzqueueQueueUrlIface,AzqueueMessageUrlIface,AzqueueMessageIdUrlIface,DequeueMessagesResponseIface)
...
import (
	...
	azqueue_service_iface "github.com/nitrictech/nitric/pkg/plugins/queue/azqueue/iface"
)
...
func (m *MockAzqueueServiceUrlIface) NewQueueURL(arg0 string) azqueue_service_iface.AzqueueQueueUrlIface {
	...
	ret0, _ := ret[0].(azqueue_service_iface.AzqueueQueueUrlIface)
	return ret0
}
...
func (m *MockAzqueueQueueUrlIface) NewMessageURL() azqueue_service_iface.AzqueueMessageUrlIface {
	...
	ret0, _ := ret[0].(azqueue_service_iface.AzqueueMessageUrlIface)
	return ret0
}
...
func (m *MockAzqueueMessageUrlIface) Dequeue(arg0 context.Context, arg1 int32, arg2 time.Duration) (azqueue_service_iface.DequeueMessagesResponseIface, error) {
	...
	ret0, _ := ret[0].(azqueue_service_iface.DequeueMessagesResponseIface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAzqueueMessageUrlIface) NewMessageIDURL(arg0 azqueue.MessageID) azqueue_service_iface.AzqueueMessageIdUrlIface {
	...
	ret0, _ := ret[0].(azqueue_service_iface.AzqueueMessageIdUrlIface)
	return ret0
}
