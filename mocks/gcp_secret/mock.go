...
// Source: github.com/nitrictech/nitric/pkg/ifaces/gcloud_secret (interfaces: SecretManagerClient,SecretIterator)
...
func (m *MockSecretManagerClient) ListSecrets(arg0 context.Context, arg1 *secretmanager.ListSecretsRequest, arg2 ...gax.CallOption) ifaces_gcloud_secret.SecretIterator {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
...
func (m *MockSecretIterator) Next() (*secretmanager.Secret, error) {
	m.ctrl.T.Helper()
