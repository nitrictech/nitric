...
// Source: github.com/nitrictech/nitric/pkg/providers/aws/core (interfaces: AwsProvider)
...
func (mr *MockAwsProviderMockRecorder) GetResources(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetResources", reflect.TypeOf((*MockAwsProvider)(nil).GetResources), arg0)
}
