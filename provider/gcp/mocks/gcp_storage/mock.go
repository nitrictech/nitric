...
// Source: github.com/nitrictech/nitric/provider/gcp/ifaces/gcloud_storage (interfaces: Reader,Writer,ObjectHandle,BucketHandle,BucketIterator,StorageClient,ObjectIterator)
