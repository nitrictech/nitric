...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "defaultHostOutput", GoGetter: "DefaultHostOutput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "gatewayIdOutput", GoGetter: "GatewayIdOutput"},
