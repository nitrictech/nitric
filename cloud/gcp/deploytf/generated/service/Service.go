...
import (
	...
	_init_ "github.com/nitrictech/nitric/cloud/gcp/deploytf/generated/service/jsii"

	"github.com/aws/constructs-go/constructs/v10"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
	"github.com/nitrictech/nitric/cloud/gcp/deploytf/generated/service/internal"
)
...
func (j *jsiiProxy_Service) ProjectId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectId",
...
func (j *jsiiProxy_Service) Region() *string {
	var returns *string
	_jsii_.Get(
		j,
		"region",
...
func (j *jsiiProxy_Service) ServiceAccountEmailOutput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceAccountEmailOutput",
		&returns,
	)
	return returns
}

func (j *jsiiProxy_Service) ServiceEndpointOutput() *string {
	var returns *string
	_jsii_.Get(
		j,
