...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "subscriberServices", GoGetter: "SubscriberServices"},
			...
			_jsii_.MemberProperty{JsiiProperty: "topicNameOutput", GoGetter: "TopicNameOutput"},
