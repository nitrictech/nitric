...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "apiGateways", GoGetter: "ApiGateways"},
			_jsii_.MemberProperty{JsiiProperty: "cdktfStack", GoGetter: "CdktfStack"},
			_jsii_.MemberProperty{JsiiProperty: "cdnDomain", GoGetter: "CdnDomain"},
			...
			_jsii_.MemberProperty{JsiiProperty: "websiteBuckets", GoGetter: "WebsiteBuckets"},
		},
		func() interface{} {
			j := jsiiProxy_Cdn{}
