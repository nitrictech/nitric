...
func (a *NitricGcpTerraformProvider) arnForResource(resource *deploymentspb.Resource) ([]*string, error) {
...
func (a *NitricGcpTerraformProvider) roleForPrincipal(resource *deploymentspb.Resource) (*string, error) {
	switch resource.Id.Type {
