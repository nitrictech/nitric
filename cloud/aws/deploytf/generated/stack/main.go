...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "websiteBucketArnOutput", GoGetter: "WebsiteBucketArnOutput"},
			_jsii_.MemberProperty{JsiiProperty: "websiteBucketDomainNameOutput", GoGetter: "WebsiteBucketDomainNameOutput"},
			_jsii_.MemberProperty{JsiiProperty: "websiteBucketIdOutput", GoGetter: "WebsiteBucketIdOutput"},
			_jsii_.MemberProperty{JsiiProperty: "websiteBucketNameOutput", GoGetter: "WebsiteBucketNameOutput"},
