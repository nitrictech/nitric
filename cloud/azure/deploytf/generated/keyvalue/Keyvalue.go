...
func (j *jsiiProxy_Keyvalue) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Keyvalue) StorageAccountName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"storageAccountName",
...
func (j *jsiiProxy_Keyvalue) TableIdOutput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tableIdOutput",
...
func (j *jsiiProxy_Keyvalue)SetName(val *string) {
...
func (j *jsiiProxy_Keyvalue)SetStorageAccountName(val *string) {
