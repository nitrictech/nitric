...
func (j *jsiiProxy_Keyvalue) validateSetNameParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Keyvalue) validateSetStorageAccountNameParameters(val *string) error {
	return nil
}
