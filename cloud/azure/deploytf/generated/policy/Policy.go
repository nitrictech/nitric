...
func (j *jsiiProxy_Policy) RoleDefinitionId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"roleDefinitionId",
...
func (j *jsiiProxy_Policy) Scope() *string {
	var returns *string
	_jsii_.Get(
		j,
		"scope",
...
func (j *jsiiProxy_Policy) ServicePrincipalId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"servicePrincipalId",
...
func (j *jsiiProxy_Policy)SetRoleDefinitionId(val *string) {
...
func (j *jsiiProxy_Policy)SetScope(val *string) {
...
func (j *jsiiProxy_Policy)SetServicePrincipalId(val *string) {
