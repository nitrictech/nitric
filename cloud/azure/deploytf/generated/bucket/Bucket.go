...
func (j *jsiiProxy_Bucket) Listeners() interface{} {
...
func (j *jsiiProxy_Bucket) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Bucket)SetListeners(val interface{}) {
...
func (j *jsiiProxy_Bucket)SetName(val *string) {
...
func (j *jsiiProxy_Bucket)SetStorageAccountId(val *string) {
