...
// Source: github.com/nitrictech/nitric/cloud/azure/runtime/resource (interfaces: AzProvider)
...
func (m *MockAzProvider) GetResources(arg0 context.Context, arg1 string) (map[string]resource.AzGenericResource, error) {
	m.ctrl.T.Helper()
