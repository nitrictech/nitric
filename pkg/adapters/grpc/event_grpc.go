...
func NewEventServiceServer(eventingPlugin eventing.EventService) pb.EventServiceServer {
...
func NewTopicServiceServer(eventService eventing.EventService) pb.TopicServiceServer {
