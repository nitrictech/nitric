...
import (
	"context"
	"github.com/nitric-dev/membrane/pkg/plugins/kv/firestore"
	"github.com/nitric-dev/membrane/tests/mocks/firestore"
	"net"
	"os"
...
var _ = Describe("Firestore KeyValue Plugin", func() {
	...
	firestorePlugin, _ = firestore_service.NewWithClient(firestoreClient)
