  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-invert-links-hover': theme('colors.purple.300'),
        '--tw-prose-invert-links-underline': theme('colors.purple.500 / 0.5'),
        '--tw-prose-invert-links-underline-hover': theme('colors.purple.500'),
